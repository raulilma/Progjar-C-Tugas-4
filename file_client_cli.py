...
server_address=('172.19.0.4',6666)
...
def remote_get(filename=""):
    try:
        ...
        if (hasil['status']=='OK'):
            ...
            # logging.warning(f"Hasil data file: {hasil['data_file']}")
        ...
        logging.warning(f"{filename} file cannot be found!")
        return False
...
if __name__=='__main__':
    server_address=('172.19.0.4',6666)
    os.chdir("./client-files")
    remote_list()
    remote_get('rfc2616.pdf')
    remote_upload('article.txt')
    remote_list()
